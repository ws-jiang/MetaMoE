...
class PeftModelForCausalLM(PeftModel):
    ...
    def __init__(self, model: PreTrainedModel, peft_config: PeftConfig, adapter_name: str = "default", pretrain_model=None) -> None:
        """
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.pretrain_model is not None:
            outputs = self.pretrain_model.forward(input_ids=input_ids,
            ...
            for name, module in self.named_modules():
                if name.endswith("moe_layer"):
                    module.sample_embedding = last_hidden_state
